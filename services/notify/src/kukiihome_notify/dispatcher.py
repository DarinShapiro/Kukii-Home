...
import structlog
from kukiihome_shared.generated.events.action_event import ActionEvent, ActionType
...
def _push_title(action: ActionEvent) -> str:
    base = "Kukii-Home alert"
    if action.tier is None:
        return base
    tier_map = {
        "tier_0_silent": "Kukii-Home (log)",
        "tier_1_in_app": "Kukii-Home",
        "tier_2_push": "Kukii-Home alert",
        "tier_3_wake": "Kukii-Home URGENT",
        "tier_4_emergency": "Kukii-Home EMERGENCY",
    }
...
class TTSDispatcher:
    ...
    async def dispatch(self, action: ActionEvent) -> dict[str, Any]:
        ...
        message = action.message or "Alert from Kukii-Home."
        data = {
