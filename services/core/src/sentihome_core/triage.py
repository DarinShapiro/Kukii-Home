...
if TYPE_CHECKING:
    ...
    from sentihome_shared.generated.events.trigger_event import TriggerEvent
...
class Triage:
    ...
    async def run(self) -> None:
        ...
        from sentihome_shared.generated.events.trigger_event import TriggerEvent as _TE
