...
if TYPE_CHECKING:
    from kukiihome_ha_agent.client import HAClient, HAState
...
class CameraLoop:
    ...
    async def run(self) -> None:
        ...
        from kukiihome_shared.motion import MOG2MotionDetector
...
class HACameraLoop:
    ...
    async def _on_state_change(self, new: HAState, old: HAState | None) -> None:
        ...
        # we can measure the HA → Kukii-Home lag downstream.
    ...
    async def _capture_and_alert(
        ...
        *,
        ...
        # Kukii-Home's /data is a different mountpoint from HA Core's.
