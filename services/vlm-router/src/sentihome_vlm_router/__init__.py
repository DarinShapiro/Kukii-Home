"""sentihome_vlm_router — multi-backend VLM router.
...
from sentihome_vlm_router.policy import RoutingDecision, RoutingPolicy
from sentihome_vlm_router.router import Router, RouterConfig
from sentihome_vlm_router.telemetry import BackendTelemetry, RequestRecord
