...
Two subjects (see ``kukiihome_shared.preprocessor.nats_subjects``):

* :data:`~kukiihome_shared.preprocessor.SUBJECT_CAMERA_CONFIGURED`
* :data:`~kukiihome_shared.preprocessor.SUBJECT_CAMERA_REMOVED`
