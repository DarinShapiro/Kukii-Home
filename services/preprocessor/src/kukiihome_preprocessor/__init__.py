"""kukiihome_preprocessor — motion-gated 24/7 frame preprocessing.
...
from kukiihome_preprocessor.cache import InMemoryMetadataCache, MetadataCache
from kukiihome_preprocessor.corroboration import CorroboratedSignal, corroborate
from kukiihome_preprocessor.motion import (
    MOG2MotionDetector,
    MotionConfig,
    MotionDecision,
    MotionDetector,
