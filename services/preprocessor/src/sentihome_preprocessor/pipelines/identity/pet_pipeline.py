...
from sentihome_preprocessor.pipelines.face import jpeg_to_bgr
from sentihome_preprocessor.pipelines.pet import detected_pet_to_actor_match
...
if TYPE_CHECKING:
    ...
    from sentihome_preprocessor.pipelines.pet import PetRecognizer
