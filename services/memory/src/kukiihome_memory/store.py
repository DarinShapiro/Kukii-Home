...
from kukiihome_memory.retention import RetentionPolicy, SoftDeleteGracePeriod
...
class MemoryStoreConfig:
    ...
    database_url: str = "postgresql+asyncpg://kukiihome:kukiihome@localhost:5432/kukiihome"
    qdrant_url: str = "http://localhost:6333"
    object_store_path: str = "/var/lib/kukiihome/objects"
    rules_top_k: int = 5
    ...
    def from_topology(cls, memory: Any) -> MemoryStoreConfig:
        """Build from :class:`kukiihome_shared.topology.MemoryConfig`.
