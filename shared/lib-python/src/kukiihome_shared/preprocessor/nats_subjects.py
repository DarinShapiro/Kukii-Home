...
(see ``kukiihome_shared.bus``):
``kukiihome.<domain>.<noun>.<verb>``.
"""
...
SUBJECT_ACTOR_ENROLLED = "kukiihome.memory.actor.enrolled"
...
SUBJECT_ACTOR_UPDATED = "kukiihome.memory.actor.updated"
"""Published when an existing KnownActor's profile changes —
embedding refresh, name change, access_profile update."""

SUBJECT_ACTOR_DEACTIVATED = "kukiihome.memory.actor.deactivated"
...
SUBJECT_CAMERA_CONFIGURED = "kukiihome.ha.camera.configured"
...
SUBJECT_CAMERA_REMOVED = "kukiihome.ha.camera.removed"
