...
Open issues and epics live in [GitHub Issues](https://github.com/DarinShapiro/SentiHome/issues). Implementation work tracks against the epics defined in [planning/](planning/).
